...
export function HeroGrowthChart() {
  return (
    <div className="relative flex h-full min-h-[320px] flex-col justify-between overflow-hidden rounded-lg border border-white/10 bg-white/[0.03] p-8 md:p-10">
      <p className="kicker text-hero-fg/50">Growth</p>

      <svg viewBox="0 0 440 260" className="w-full flex-1" preserveAspectRatio="none">
